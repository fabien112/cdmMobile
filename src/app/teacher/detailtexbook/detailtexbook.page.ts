...
@Component({
  selector: 'app-detailtexbook',
  templateUrl: './detailtexbook.page.html',
  styleUrls: ['./detailtexbook.page.scss'],
})
export class DetailtexbookPage implements OnInit {
        ...
        private router :Router)
    {
        ...
        this.Details = JSON.parse(localStorage.getItem("detailsTexbooks"));
